...
<html>
  <head>
    ...
    <title>Ejemplo - Materiales</title>
  ...
  <div class="row">
    ...
    <div class="col-sm-2"><h2>
		<img border="0" src="../img/nuevo.png" width="48" height="48" title="Ingresar Material" 
		onclick=location.href='materiales.php'; onKeyPress=location.href='promocion.php';
  ...
  <div class="col-sm-2"><h2>Ejemplo</h2></div>
    ...
    <p class="lead"><h2>Materiales</h2></p>
  </div>
...
?>    
        <div class="list-group">
			...
			<?php 				
				$long = count($materiales);
				for($i=0; $i< $long; $i++){
				?>
		<div class="list-group">
				
				<a 	<?php echo "href=modifica.php?id=".$materiales[$i]['idmat'];?>
						 class="list-group-item">
				<h4 class="list-group-item-heading"> <?php echo $materiales[$i]['nombremat'];?> </h4>
				<p class="list-group-item-text"><?php echo $materiales[$i]['preciomat'];?></p>		 
				</a>	</div>
		<?php  } ?>
