...
?>
  ...
  <div class="row">
    <div class="col-sm-2"><h2>
		<img border="0" src="../img/atras.png" width="48" height="48" title="Volver al menú" 
							...
							onKeyPress=location.href='../promos/'; 
  ...
  <div class="py-5 text-center">
	<p class="text-danger" >IMPORTANTE!: Al eliminar el material, se eliminarán 
...
<hr class="mb-4">
        <button class="btn btn-warning btn-lg btn-block" type="button">Si,deseo eliminar el material</button>
